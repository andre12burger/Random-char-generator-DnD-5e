...
INSERT INTO item_weapons_types (name, description) VALUES
    ('Melee', 'A melee weapon is used to attack a target within 5 feet of you'),
    ('Ranged', 'A ranged weapon is used to attack a target at a distance'),
    ('Improvised', 'Objects not designed as weapons but used in combat. Can be used as melee or thrown depending on the object and circumstances');

-- Categorias de armas
INSERT INTO item_weapons_categories (name, description) VALUES
    ('Simple', 'Basic weapons that are easy to use. Most characters are proficient with these weapons.'),
    ('Martial', 'Advanced weapons that require specialized training to use effectively.'),
    ('Improvised', 'Objects not designed as weapons but used in combat. Characters are not proficient with improvised weapons unless they resemble a weapon the character is proficient with.'),
    ('Unarmed', 'Natural attacks using fists, feet, elbows, knees, and head. All characters are proficient with unarmed attacks.');
...
INSERT INTO item_weapons (
    ...
    -- CLUB
    ('Club',
        (SELECT id FROM item_weapons_categories WHERE name = 'Simple'),
        (SELECT id FROM item_weapons_types WHERE name = 'Melee'),
        '1d4',
        (SELECT id FROM core_damage_types WHERE name = 'Bludgeoning'),
        1.00,  -- 1 sp
        (SELECT id FROM core_currency_types WHERE code = 'sp'),
        2.00,
        (SELECT id FROM core_measurement_units WHERE code = 'lb'),
        (SELECT id FROM items WHERE name = 'weapons'),
    ...
    ('Dagger',
        ...
        (SELECT id FROM item_weapons_types WHERE name = 'Melee'),
        '1d4',
        (SELECT id FROM core_damage_types WHERE name = 'Piercing'),
        2.00,
    ...
    ('Handaxe',
        ...
        (SELECT id FROM item_weapons_types WHERE name = 'Melee'),
        '1d6',
        (SELECT id FROM core_damage_types WHERE name = 'Slashing'),
        5.00,
        (SELECT id FROM core_currency_types WHERE code = 'gp'),
        2.00,
        (SELECT id FROM core_measurement_units WHERE code = 'lb'),
...
INSERT INTO item_weapons (
    ...
    ('Crossbow, light',
        (SELECT id FROM item_weapons_categories WHERE name = 'Simple'),
        (SELECT id FROM item_weapons_types WHERE name = 'Ranged'),
        '1d8',
        (SELECT id FROM core_damage_types WHERE name = 'Piercing'),
        25.00,
        (SELECT id FROM core_currency_types WHERE code = 'gp'),
    ...
    ('Dart',
        ...
        (SELECT id FROM core_damage_types WHERE name = 'Piercing'),
        5.00,
        (SELECT id FROM core_currency_types WHERE code = 'cp'),
        0.25,
        (SELECT id FROM core_measurement_units WHERE code = 'lb'),
        (SELECT id FROM items WHERE name = 'weapons'),
        (SELECT id FROM core_books WHERE code = 'PHB'),
...
INSERT INTO item_weapons (
    ...
    -- BATTLEAXE
    ('Battleaxe',
        (SELECT id FROM item_weapons_categories WHERE name = 'Martial'),
        (SELECT id FROM item_weapons_types WHERE name = 'Melee'),
        '1d8',
        (SELECT id FROM core_damage_types WHERE name = 'Slashing'),
        10.00,
...
INSERT INTO item_weapons (
    ...
    'Improvised Weapon',
    (SELECT id FROM item_weapons_categories WHERE name = 'Improvised'),  -- Categoria: Improvised
    (SELECT id FROM item_weapons_types WHERE name = 'Improvised'),       -- Tipo: Improvised
    '1d4',                                                               -- Dano: 1d4
    NULL,                                                                -- Tipo de dano: NULL (DM decide)
    0.00,                                                                -- Custo: 0 (objetos encontrados)
    (SELECT id FROM core_currency_types WHERE name = 'Gold'),            -- Moeda: Gold (padrão)
    1.00,                                                                -- Peso: 1 lb (média)
    (SELECT id FROM core_measurement_units WHERE name = 'Pounds'),       -- Unidade: Pounds
    (SELECT id FROM items WHERE name = 'weapons'),                      -- Categoria de item: weapons
    (SELECT id FROM core_books WHERE code = 'PHB'),                     -- Livro: Player's Handbook
...
INSERT INTO item_weapons_ranges (weapon_id, normal_range, maximum_range, unit_id) VALUES (
    (SELECT id FROM item_weapons WHERE name = 'Improvised Weapon'),
    20,                                                                  -- Alcance normal: 20 pés
    60,                                                                  -- Alcance máximo: 60 pés
    (SELECT id FROM core_measurement_units WHERE name = 'Feet')          -- Unidade: pés
);
...
INSERT INTO item_weapons (
    ...
    'Unarmed Strike',
    (SELECT id FROM item_weapons_categories WHERE name = 'Unarmed'),      -- Categoria: Unarmed
    (SELECT id FROM item_weapons_types WHERE name = 'Melee'),             -- Tipo: Melee
    '1',                                                                  -- Dano: 1 (fixo)
    (SELECT id FROM core_damage_types WHERE name = 'Bludgeoning'),        -- Tipo de dano: Bludgeoning
