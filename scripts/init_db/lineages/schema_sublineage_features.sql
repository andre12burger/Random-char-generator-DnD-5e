...
FROM sublineages s WHERE s.parent_lineage_slug = 'dwarf' AND s.slug = 'hill-dwarf';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Dwarven Armor Training', 'You have proficiency with light and medium armor.'
FROM sublineages s WHERE s.parent_lineage_slug = 'dwarf' AND s.slug = 'mountain-dwarf';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'dwarf' AND s.slug = 'mark-of-warding';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'elf' AND s.slug = 'high-elf';
...
INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Elf Weapon Training', 'You have proficiency with the longsword, shortsword, shortbow, and longbow.'
FROM sublineages s WHERE s.parent_lineage_slug = 'elf' AND s.slug = 'wood-elf';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'halfling' AND s.slug = 'lightfoot-halfling';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'halfling' AND s.slug = 'stout-halfling';
INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
...
FROM sublineages s WHERE s.parent_lineage_slug = 'tiefling' AND s.slug = 'asmodeus-tiefling';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'black-dragonborn';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'blue-dragonborn';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'brass-dragonborn';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Lightning Breath Weapon', 'When you use your Breath Weapon, each creature in the area of the exhalation must make a Dexterity saving throw. The DC for this saving throw equals 8 + your Constitution modifier + your proficiency bonus. A creature takes 2d6 lightning damage on a failed save, and half as much damage on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level.'
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'bronze-dragonborn';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Acid Breath Weapon', 'When you use your Breath Weapon, each creature in the area of the exhalation must make a Dexterity saving throw. The DC for this saving throw equals 8 + your Constitution modifier + your proficiency bonus. A creature takes 2d6 acid damage on a failed save, and half as much damage on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level.'
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'copper-dragonborn';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Fire Breath Weapon', 'When you use your Breath Weapon, each creature in the area of the exhalation must make a Dexterity saving throw. The DC for this saving throw equals 8 + your Constitution modifier + your proficiency bonus. A creature takes 2d6 fire damage on a failed save, and half as much damage on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level.'
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'gold-dragonborn';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'green-dragonborn';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Fire Breath Weapon', 'When you use your Breath Weapon, each creature in the area of the exhalation must make a Dexterity saving throw. The DC for this saving throw equals 8 + your Constitution modifier + your proficiency bonus. A creature takes 2d6 fire damage on a failed save, and half as much damage on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level.'
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'red-dragonborn';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'silver-dragonborn';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Cold Breath Weapon', 'When you use your Breath Weapon, each creature in the area of the exhalation must make a Dexterity saving throw. The DC for this saving throw equals 8 + your Constitution modifier + your proficiency bonus. A creature takes 2d6 cold damage on a failed save, and half as much damage on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level.'
FROM sublineages s WHERE s.parent_lineage_slug = 'dragonborn' AND s.slug = 'white-dragonborn';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'gnome' AND s.slug = 'forest-gnome';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'gnome' AND s.slug = 'rock-gnome';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'gnome' AND s.slug = 'mark-of-scribing';
...
INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Cantrip', 'You know one cantrip of your choice from the wizard spell list. Intelligence is your spellcasting ability for it.'
FROM sublineages s WHERE s.parent_lineage_slug = 'half-elf' AND s.slug = 'high-half-elf';
...
INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Fleet of Foot', 'Your base walking speed increases to 35 feet.'
FROM sublineages s WHERE s.parent_lineage_slug = 'half-elf' AND s.slug = 'wood-half-elf';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'half-elf' AND s.slug = 'drow-half-elf';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'half-orc' AND s.slug = 'mark-of-finding';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'aasimar' AND s.slug = 'protector-aasimar';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'aasimar' AND s.slug = 'scourge-aasimar';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'aasimar' AND s.slug = 'fallen-aasimar';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'goliath' AND s.slug = 'cloud-goliath';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'goliath' AND s.slug = 'fire-goliath';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'goliath' AND s.slug = 'frost-goliath';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Hill''s Toughness', 'Your hit point maximum increases by 1, and it increases by 1 every time you gain a level.'
FROM sublineages s WHERE s.parent_lineage_slug = 'goliath' AND s.slug = 'hill-goliath';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Stone''s Endurance', 'You can focus yourself to occasionally shrug off injury. When you take damage, you can use your reaction to roll a d12. Add your Constitution modifier to the number rolled, and reduce the damage by that total. After you use this trait, you can''t use it again until you finish a short or long rest.'
FROM sublineages s WHERE s.parent_lineage_slug = 'goliath' AND s.slug = 'stone-goliath';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'goliath' AND s.slug = 'storm-goliath';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'lizardfolk' AND s.slug = 'green-lizardfolk';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Hold Breath', 'You can hold your breath for up to 15 minutes at a time.'
FROM sublineages s WHERE s.parent_lineage_slug = 'lizardfolk' AND s.slug = 'black-lizardfolk';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Underwater Adaptation', 'You can breathe underwater, and you have a swimming speed equal to your walking speed.'
FROM sublineages s WHERE s.parent_lineage_slug = 'lizardfolk' AND s.slug = 'gray-lizardfolk';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Desert Camouflage', 'You have advantage on Dexterity (Stealth) checks made to hide in desert terrain.'
FROM sublineages s WHERE s.parent_lineage_slug = 'lizardfolk' AND s.slug = 'poison-dusk-lizardfolk';

-- Tabaxi sublineage features
INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Skill Versatility', 'You gain proficiency in two skills of your choice.'
FROM sublineages s WHERE s.parent_lineage_slug = 'tabaxi' AND s.slug = 'leopard-tabaxi';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Skill Versatility', 'You gain proficiency in two skills of your choice.'
FROM sublineages s WHERE s.parent_lineage_slug = 'tabaxi' AND s.slug = 'tiger-tabaxi';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Skill Versatility', 'You gain proficiency in two skills of your choice.'
FROM sublineages s WHERE s.parent_lineage_slug = 'tabaxi' AND s.slug = 'jaguar-tabaxi';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'triton' AND s.slug = 'blue-triton';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Emissary of the Sea', 'Aquatic beasts have an extraordinary affinity with your people. You can communicate simple ideas with any of them. In battle, they are unlikely to attack you unless you attack them first.'
FROM sublineages s WHERE s.parent_lineage_slug = 'triton' AND s.slug = 'black-triton';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Emissary of the Sea', 'Aquatic beasts have an extraordinary affinity with your people. You can communicate simple ideas with any of them. In battle, they are unlikely to attack you unless you attack them first.'
FROM sublineages s WHERE s.parent_lineage_slug = 'triton' AND s.slug = 'green-triton';

INSERT INTO sublineage_features (sublineage_id, available_at_level, name, description)
SELECT s.id, 1, 'Emissary of the Sea', 'Aquatic beasts have an extraordinary affinity with your people. You can communicate simple ideas with any of them. In battle, they are unlikely to attack you unless you attack them first.'
FROM sublineages s WHERE s.parent_lineage_slug = 'triton' AND s.slug = 'white-triton';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'tiefling' AND s.slug = 'baalzebul-tiefling';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'tiefling' AND s.slug = 'dispater-tiefling';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'tiefling' AND s.slug = 'fierna-tiefling';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'tiefling' AND s.slug = 'glasya-tiefling';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'tiefling' AND s.slug = 'levistus-tiefling';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'tiefling' AND s.slug = 'mammon-tiefling';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'tiefling' AND s.slug = 'mephistopheles-tiefling';
...
FROM sublineages s WHERE s.parent_lineage_slug = 'tiefling' AND s.slug = 'zariel-tiefling';
