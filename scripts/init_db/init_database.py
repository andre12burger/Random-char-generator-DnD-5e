...
class DatabaseInitializer:
    ...
    def __init__(self):
        ...
        self.schemas: List[str] = [
            ...
            "core/01_schema_books.sql",

            "core/02_seed_books.sql",
            "core/02_schema_core.sql",

            "core/03_seed_core.sql"
    ...
    def _parse_sql_commands(self, sql_script: str) -> List[str]:
        ...
        for line in sql_script.split('\n'):
            ...
            if '--' in line:
                # Procura por -- fora de strings (considera escape por duplicação de aspas)
                in_string = False
                quote_char = None
                for i, char in enumerate(line):
                    if char in ['"', "'"] and (i == 0 or line[i-1] != '\\'):
                        if not in_string:
                            ...
                            # Se for uma aspa duplicada (''), considera como caracter escapado dentro da string
