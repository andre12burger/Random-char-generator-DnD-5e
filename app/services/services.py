...
from ..models.atributos import gera_atributos, teste_resistencia, modificador, proeficiencia
from ..models.informacoes_banco_dados import *
...
def define_background():
    ...
    nome_background = escolhe_background(lista_livros_ativos)
    personagem.basicas.background = nome_background
    
    lista_informacoes_background, lista_features_background = informacoes_background(personagem.basicas.background)
    ...
    str_features_background = [f'Background: {lista_informacoes_background[0]}']

    str_features_background.append(lista_informacoes_background[index] for index in lista_features_background)

    personagem.basicas.features.append(str_features_background)
...
def page_1():
    ...
    dict_fields_pdf = soma_dicionarios(
            ...
            define_experiencia(),
            dict_background,
            features_pdf(personagem.basicas.features)
            )
