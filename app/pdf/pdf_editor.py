from app.models.atributos import positivo, positivo_lista, proeficiencia, teste_resistencia
...
def features_pdf(lista_features):
    
    for elemento in lista_features:
        dict_features = {'Features and Traits': elemento}
